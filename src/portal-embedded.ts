...
import P_0_assets_index_DoByzPQd_js from '../portal/dist/assets/index-DoByzPQd.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
import P_1_assets_index_wL5o5bze_css from '../portal/dist/assets/index-wL5o5bze.css' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  "/portal/assets/index-DoByzPQd.js": { path: P_0_assets_index_DoByzPQd_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/portal/assets/index-wL5o5bze.css": { path: P_1_assets_index_wL5o5bze_css as unknown as string, mime: "text/css; charset=utf-8" },
