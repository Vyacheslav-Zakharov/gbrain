...
import P_0_assets_index_CKX_O1DA_css from '../portal/dist/assets/index-CKX_O1DA.css' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
import P_1_assets_index_DOOrp_BB_js from '../portal/dist/assets/index-DOOrp_BB.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  "/portal/assets/index-CKX_O1DA.css": { path: P_0_assets_index_CKX_O1DA_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/portal/assets/index-DOOrp_BB.js": { path: P_1_assets_index_DOOrp_BB_js as unknown as string, mime: "application/javascript; charset=utf-8" },
