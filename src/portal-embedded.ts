...
import P_0_assets_index_Cc1OHDpS_js from '../portal/dist/assets/index-Cc1OHDpS.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
import P_1_assets_index_shmrjZ0i_css from '../portal/dist/assets/index-shmrjZ0i.css' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  "/portal/assets/index-Cc1OHDpS.js": { path: P_0_assets_index_Cc1OHDpS_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/portal/assets/index-shmrjZ0i.css": { path: P_1_assets_index_shmrjZ0i_css as unknown as string, mime: "text/css; charset=utf-8" },
