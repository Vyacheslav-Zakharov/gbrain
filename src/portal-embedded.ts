...
// @ts-ignore — type: file is Bun ESM syntax
import P_1_assets_index_CXhPwmHc_js from '../portal/dist/assets/index-CXhPwmHc.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  "/portal/assets/index-BhKGH_Hf.css": { path: P_0_assets_index_BhKGH_Hf_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/portal/assets/index-CXhPwmHc.js": { path: P_1_assets_index_CXhPwmHc_js as unknown as string, mime: "application/javascript; charset=utf-8" },
