...
// @ts-ignore — type: file is Bun ESM syntax
import P_1_assets_index_De5sqmtE_js from '../portal/dist/assets/index-De5sqmtE.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  ...
  "/portal/assets/index-De5sqmtE.js": { path: P_1_assets_index_De5sqmtE_js as unknown as string, mime: "application/javascript; charset=utf-8" },
