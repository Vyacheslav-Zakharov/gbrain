...
import P_0_assets_index_C_CgITaR_js from '../portal/dist/assets/index-C-CgITaR.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  "/portal/assets/index-C-CgITaR.js": { path: P_0_assets_index_C_CgITaR_js as unknown as string, mime: "application/javascript; charset=utf-8" },
