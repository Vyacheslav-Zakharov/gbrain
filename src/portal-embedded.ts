...
// @ts-ignore — type: file is Bun ESM syntax
import P_1_assets_index_SJl1EIFC_js from '../portal/dist/assets/index-SJl1EIFC.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  ...
  "/portal/assets/index-SJl1EIFC.js": { path: P_1_assets_index_SJl1EIFC_js as unknown as string, mime: "application/javascript; charset=utf-8" },
