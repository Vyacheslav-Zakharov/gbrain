...
import P_0_assets_index_7g_KG9GZ_js from '../portal/dist/assets/index-7g-KG9GZ.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  "/portal/assets/index-7g-KG9GZ.js": { path: P_0_assets_index_7g_KG9GZ_js as unknown as string, mime: "application/javascript; charset=utf-8" },
