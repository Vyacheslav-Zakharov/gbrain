...
// @ts-ignore — type: file is Bun ESM syntax
import P_1_assets_index_D8lKIJ6Y_js from '../portal/dist/assets/index-D8lKIJ6Y.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  ...
  "/portal/assets/index-D8lKIJ6Y.js": { path: P_1_assets_index_D8lKIJ6Y_js as unknown as string, mime: "application/javascript; charset=utf-8" },
