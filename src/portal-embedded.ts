...
import P_0_assets_index_DrtaSOqM_js from '../portal/dist/assets/index-DrtaSOqM.js' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
import P_1_assets_index_NFz6bO7V_css from '../portal/dist/assets/index-NFz6bO7V.css' with { type: 'file' };
// @ts-ignore — type: file is Bun ESM syntax
...
export const PORTAL_ASSETS: Record<string, PortalAsset> = {
  "/portal/assets/index-DrtaSOqM.js": { path: P_0_assets_index_DrtaSOqM_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/portal/assets/index-NFz6bO7V.css": { path: P_1_assets_index_NFz6bO7V_css as unknown as string, mime: "text/css; charset=utf-8" },
