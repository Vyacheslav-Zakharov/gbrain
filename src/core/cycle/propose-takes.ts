 ...
 */
export const PROPOSE_TAKES_PROMPT_VERSION = 'v0.36.1.8-observable-all-untrusted-input-v1';
...
class ProposeTakesPhase extends BaseCyclePhase {
  ...
  protected async process(
    ...
    for (const page of pages) {
      ...
      if (scope.sourceId && page.source_id && page.source_id !== scope.sourceId) {
        result.technical_failures += 1;
        result.warnings.push(`source containment violation: requested ${scope.sourceId}, received ${page.source_id}/${page.slug}`);
        continue;
      }
