...
import A_0_assets_index_B_ww_6uq_js from '../admin/dist/assets/index-B_ww-6uq.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-B_ww-6uq.js": { path: A_0_assets_index_B_ww_6uq_js as unknown as string, mime: "application/javascript; charset=utf-8" },
