...
import A_0_assets_index_CfRjJpO__js from '../admin/dist/assets/index-CfRjJpO-.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_LQCg_tFv_css from '../admin/dist/assets/index-LQCg-tFv.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-CfRjJpO-.js": { path: A_0_assets_index_CfRjJpO__js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-LQCg-tFv.css": { path: A_1_assets_index_LQCg_tFv_css as unknown as string, mime: "text/css; charset=utf-8" },
