...
import A_0_assets_index_sv92OZb6_js from '../admin/dist/assets/index-sv92OZb6.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_yIG9q46m_css from '../admin/dist/assets/index-yIG9q46m.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-sv92OZb6.js": { path: A_0_assets_index_sv92OZb6_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-yIG9q46m.css": { path: A_1_assets_index_yIG9q46m_css as unknown as string, mime: "text/css; charset=utf-8" },
