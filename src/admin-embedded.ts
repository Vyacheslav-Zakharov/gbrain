...
import A_0_assets_index_C0NLV38l_js from '../admin/dist/assets/index-C0NLV38l.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_D2PyPtPD_css from '../admin/dist/assets/index-D2PyPtPD.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-C0NLV38l.js": { path: A_0_assets_index_C0NLV38l_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-D2PyPtPD.css": { path: A_1_assets_index_D2PyPtPD_css as unknown as string, mime: "text/css; charset=utf-8" },
