...
import A_0_assets_index_BlNHY7RY_js from '../admin/dist/assets/index-BlNHY7RY.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-BlNHY7RY.js": { path: A_0_assets_index_BlNHY7RY_js as unknown as string, mime: "application/javascript; charset=utf-8" },
