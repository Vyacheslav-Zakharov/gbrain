...
import A_0_assets_index_Cb4jCY21_css from '../admin/dist/assets/index-Cb4jCY21.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_CxBfunFq_js from '../admin/dist/assets/index-CxBfunFq.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-Cb4jCY21.css": { path: A_0_assets_index_Cb4jCY21_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-CxBfunFq.js": { path: A_1_assets_index_CxBfunFq_js as unknown as string, mime: "application/javascript; charset=utf-8" },
