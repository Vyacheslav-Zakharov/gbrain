...
import A_0_assets_index_D5Hlu8HF_css from '../admin/dist/assets/index-D5Hlu8HF.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_n6IPbBgs_js from '../admin/dist/assets/index-n6IPbBgs.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-D5Hlu8HF.css": { path: A_0_assets_index_D5Hlu8HF_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-n6IPbBgs.js": { path: A_1_assets_index_n6IPbBgs_js as unknown as string, mime: "application/javascript; charset=utf-8" },
