...
import A_0_assets_index_BzGYu1oN_js from '../admin/dist/assets/index-BzGYu1oN.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-BzGYu1oN.js": { path: A_0_assets_index_BzGYu1oN_js as unknown as string, mime: "application/javascript; charset=utf-8" },
