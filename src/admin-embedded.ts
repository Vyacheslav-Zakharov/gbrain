...
import A_0_assets_index_Dw_E6mUU_js from '../admin/dist/assets/index-Dw_E6mUU.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-Dw_E6mUU.js": { path: A_0_assets_index_Dw_E6mUU_js as unknown as string, mime: "application/javascript; charset=utf-8" },
