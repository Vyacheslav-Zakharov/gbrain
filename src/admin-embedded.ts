...
// Source: admin/dist/ at 2026-08-10.
//
...
import A_0_assets_index_pLu6CjXb_js from '../admin/dist/assets/index-pLu6CjXb.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_zm0ZoNs9_css from '../admin/dist/assets/index-zm0ZoNs9.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-pLu6CjXb.js": { path: A_0_assets_index_pLu6CjXb_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-zm0ZoNs9.css": { path: A_1_assets_index_zm0ZoNs9_css as unknown as string, mime: "text/css; charset=utf-8" },
