...
import A_0_assets_index_CmOkse60_js from '../admin/dist/assets/index-CmOkse60.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_DlcUO_fs_css from '../admin/dist/assets/index-DlcUO_fs.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-CmOkse60.js": { path: A_0_assets_index_CmOkse60_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-DlcUO_fs.css": { path: A_1_assets_index_DlcUO_fs_css as unknown as string, mime: "text/css; charset=utf-8" },
