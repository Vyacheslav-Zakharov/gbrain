...
import A_0_assets_index_B2A4fyZv_js from '../admin/dist/assets/index-B2A4fyZv.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_DjMxz0ok_css from '../admin/dist/assets/index-DjMxz0ok.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-B2A4fyZv.js": { path: A_0_assets_index_B2A4fyZv_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-DjMxz0ok.css": { path: A_1_assets_index_DjMxz0ok_css as unknown as string, mime: "text/css; charset=utf-8" },
