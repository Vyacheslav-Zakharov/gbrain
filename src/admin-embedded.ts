...
import A_0_assets_index_CZxXSqVT_js from '../admin/dist/assets/index-CZxXSqVT.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index__28SMS4G_css from '../admin/dist/assets/index-_28SMS4G.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-CZxXSqVT.js": { path: A_0_assets_index_CZxXSqVT_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-_28SMS4G.css": { path: A_1_assets_index__28SMS4G_css as unknown as string, mime: "text/css; charset=utf-8" },
