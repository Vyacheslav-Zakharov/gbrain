...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_Dc6A_UY9_js from '../admin/dist/assets/index-Dc6A_UY9.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-Dc6A_UY9.js": { path: A_1_assets_index_Dc6A_UY9_js as unknown as string, mime: "application/javascript; charset=utf-8" },
