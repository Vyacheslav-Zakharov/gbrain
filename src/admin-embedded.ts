...
import A_0_assets_index_53bFsSRW_js from '../admin/dist/assets/index-53bFsSRW.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_BdVZmpf1_css from '../admin/dist/assets/index-BdVZmpf1.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-53bFsSRW.js": { path: A_0_assets_index_53bFsSRW_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-BdVZmpf1.css": { path: A_1_assets_index_BdVZmpf1_css as unknown as string, mime: "text/css; charset=utf-8" },
