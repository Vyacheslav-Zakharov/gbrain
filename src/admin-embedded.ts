...
import A_0_assets_index_BtK5s4WB_js from '../admin/dist/assets/index-BtK5s4WB.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-BtK5s4WB.js": { path: A_0_assets_index_BtK5s4WB_js as unknown as string, mime: "application/javascript; charset=utf-8" },
