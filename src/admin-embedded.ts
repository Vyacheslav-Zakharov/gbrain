...
import A_0_assets_index_Crz2LreD_js from '../admin/dist/assets/index-Crz2LreD.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_Ctp9RZ_z_css from '../admin/dist/assets/index-Ctp9RZ-z.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-Crz2LreD.js": { path: A_0_assets_index_Crz2LreD_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-Ctp9RZ-z.css": { path: A_1_assets_index_Ctp9RZ_z_css as unknown as string, mime: "text/css; charset=utf-8" },
