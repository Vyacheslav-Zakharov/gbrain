...
import A_0_assets_index_BdITVJyN_js from '../admin/dist/assets/index-BdITVJyN.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-BdITVJyN.js": { path: A_0_assets_index_BdITVJyN_js as unknown as string, mime: "application/javascript; charset=utf-8" },
