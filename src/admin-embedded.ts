...
import A_0_assets_index_CkJF9VJk_js from '../admin/dist/assets/index-CkJF9VJk.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-CkJF9VJk.js": { path: A_0_assets_index_CkJF9VJk_js as unknown as string, mime: "application/javascript; charset=utf-8" },
