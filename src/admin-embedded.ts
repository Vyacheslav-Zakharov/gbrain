...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_DHD_V2V9_js from '../admin/dist/assets/index-DHD-V2V9.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-DHD-V2V9.js": { path: A_1_assets_index_DHD_V2V9_js as unknown as string, mime: "application/javascript; charset=utf-8" },
