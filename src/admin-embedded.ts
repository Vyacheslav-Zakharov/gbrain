...
// Source: admin/dist/ at 2026-07-02.
//
...
import A_0_assets_index_FsfhPmxY_js from '../admin/dist/assets/index-FsfhPmxY.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-FsfhPmxY.js": { path: A_0_assets_index_FsfhPmxY_js as unknown as string, mime: "application/javascript; charset=utf-8" },
