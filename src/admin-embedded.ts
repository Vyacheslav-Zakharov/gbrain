...
// Source: admin/dist/ at 2026-08-18.
//
...
import A_0_assets_index_DdUE5xHx_js from '../admin/dist/assets/index-DdUE5xHx.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_Dz6SzAoq_css from '../admin/dist/assets/index-Dz6SzAoq.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-DdUE5xHx.js": { path: A_0_assets_index_DdUE5xHx_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-Dz6SzAoq.css": { path: A_1_assets_index_Dz6SzAoq_css as unknown as string, mime: "text/css; charset=utf-8" },
