...
import A_0_assets_index_AzJuxk9O_css from '../admin/dist/assets/index-AzJuxk9O.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_CsUN5b_9_js from '../admin/dist/assets/index-CsUN5b_9.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-AzJuxk9O.css": { path: A_0_assets_index_AzJuxk9O_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-CsUN5b_9.js": { path: A_1_assets_index_CsUN5b_9_js as unknown as string, mime: "application/javascript; charset=utf-8" },
