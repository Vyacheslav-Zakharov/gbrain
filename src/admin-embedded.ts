...
// Source: admin/dist/ at 2026-08-01.
//
...
import A_0_assets_index_CeyYTy40_css from '../admin/dist/assets/index-CeyYTy40.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_DMT5Bi8N_js from '../admin/dist/assets/index-DMT5Bi8N.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-CeyYTy40.css": { path: A_0_assets_index_CeyYTy40_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-DMT5Bi8N.js": { path: A_1_assets_index_DMT5Bi8N_js as unknown as string, mime: "application/javascript; charset=utf-8" },
