...
import A_0_assets_index_DJWhNa1x_js from '../admin/dist/assets/index-DJWhNa1x.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-DJWhNa1x.js": { path: A_0_assets_index_DJWhNa1x_js as unknown as string, mime: "application/javascript; charset=utf-8" },
