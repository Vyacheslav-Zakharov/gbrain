...
import A_0_assets_index_Bq2WF1j6_css from '../admin/dist/assets/index-Bq2WF1j6.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_Dip3Faqy_js from '../admin/dist/assets/index-Dip3Faqy.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-Bq2WF1j6.css": { path: A_0_assets_index_Bq2WF1j6_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-Dip3Faqy.js": { path: A_1_assets_index_Dip3Faqy_js as unknown as string, mime: "application/javascript; charset=utf-8" },
