 ...
 */
export function RejectReasonSheet({ reasons, busy, status, onCancel, onConfirm }: Props) {
  ...
  return (
    <div className="review-sheet-backdrop" role="presentation" onClick={event => { if (!busy && event.target === event.currentTarget) onCancel(); }}>
