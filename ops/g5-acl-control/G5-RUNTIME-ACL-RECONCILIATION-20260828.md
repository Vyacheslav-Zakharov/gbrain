...
- `G5-RUNTIME-ROUTINE-TYPE-ACL-FRAGMENT-NOEXEC.sql.txt` / inverse — exact `postgres` superuser forward; revoke PUBLIC EXECUTE on 113 routines, grant four provisional exact runtime signatures and two extension types, set global function/type default ACLs for both object creators; diagnostic inverse only; SHA-256 `e16c09f3418b7de6c0e3dc41f1e75b91e86d8fb21e0ec111ab9c1fd80d0cabe4` / `a3e8176ce1eeca919447f7d67727aac60265abbe62a2b6e1efc0822484d98138`.
- `G5-RUNTIME-ACL-EXACT-POSTCONDITIONS-NOEXEC.sql.txt` — exact catalog/owner/ACL/grantor/grantee/grant-option/default/column/policy/role/index/extension-member/full-trigger closure; SHA-256 `582bb89d7966049dea5ba3ad66676c4a98cd8420779e00fca0bc38b049f9837d`.
...
- `G5-ACL-S2-ASSEMBLED-NOEXEC.sql.txt` — component-manifest-verified deterministic one-transaction assembly of the four forward fragments; SHA-256 `6cb1706fda31d2f7b224e8ac5db698ef8cbf8efec2cf6952f6511dcb0e9e25ed`.
