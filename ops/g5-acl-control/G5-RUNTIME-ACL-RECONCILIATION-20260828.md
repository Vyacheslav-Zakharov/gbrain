...
- `G5-RUNTIME-ACL-EXACT-INVERSE-POSTCONDITIONS-NOEXEC.sql.txt` — exact verifier after full database plus cluster-role/auth restoration with a new controlled recovery credential; owner-self ordinary ACL tuples use PostgreSQL 16 `is_grantable=false` semantics; SHA-256 `4b57d2da94a0cd108fe2f5038f2dfb34ddda5546a5bacd262ac030d97cf7a2e8`.
