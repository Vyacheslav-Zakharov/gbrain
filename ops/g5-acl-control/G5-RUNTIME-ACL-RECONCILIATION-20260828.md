...
- `G5-RUNTIME-ACL-EXACT-INVERSE-POSTCONDITIONS-NOEXEC.sql.txt` — exact verifier after full database plus cluster-role/auth restoration with a new controlled recovery credential; owner-self ordinary ACL tuples use PostgreSQL 16 `is_grantable=false` semantics; SHA-256 `7f3b14c64e51559b329b8a5660cfffc6ef712e18a8e6581b134e60130424e5ff`.
