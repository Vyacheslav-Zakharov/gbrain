...
- `G5-RUNTIME-ROUTINE-TYPE-ACL-FRAGMENT-NOEXEC.sql.txt` / inverse — exact `postgres` superuser forward; revoke PUBLIC EXECUTE on 113 routines, grant five evidence-bound exact runtime signatures and two extension types, set global function/type default ACLs for both object creators; diagnostic inverse only; SHA-256 `937f6b20ca44e6497f0ebc9c50c80c398728be940dc0b6a73a934786a2baf5d5` / `8424e85a0b4a839620b9a3d49d4654d807165e6290345c13da0011250fef2a74`.
- `G5-RUNTIME-ACL-EXACT-POSTCONDITIONS-NOEXEC.sql.txt` — exact catalog/owner/ACL/grantor/grantee/grant-option/default/column/policy/role/index/extension-member/full-trigger closure; SHA-256 `aa684c516f9ca2027f1236e4100495c18e883f61003a764e5dd96baa041765f1`.
- `G5-RUNTIME-ACL-EXACT-INVERSE-POSTCONDITIONS-NOEXEC.sql.txt` — exact verifier after full database plus cluster-role/auth restoration with a new controlled recovery credential; owner-self ordinary ACL tuples use PostgreSQL 16 `is_grantable=false` semantics and NULL sequence ACLs expand with object code lowercase `s`; SHA-256 `10a5bd21fefc7ce3494b7d4707e1e3534bdb68f7cab5995df04cbf00b7d40988`.
- `G5-ACL-S2-ASSEMBLED-NOEXEC.sql.txt` — component-manifest-verified deterministic one-transaction assembly of the four forward fragments; SHA-256 `6eee5632ef38da42c687329738ee75027360dec81c825a0cb6046a7fd782bc47`.
